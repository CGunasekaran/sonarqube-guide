  ...
  const tips: Tip[] = [
    {
      ...
      description:
        "Properly configure JVM heap size for SonarQube server components to prevent OutOfMemory errors and improve analysis speed.",
      implementation: [
...
sonar.search.javaOpts=-Xmx1024m -Xms512m`,
    ...
    },
    {
      ...
      description:
        "Configure database connection pool size to handle concurrent analyses and reduce database wait times.",
      implementation: [
...
sonar.jdbc.maxWait=5000`,
      metrics: [
        ...
        "Better concurrent analysis handling",
    ...
    },
    {
      ...
      description:
        "Adjust the number of Compute Engine workers to process background tasks faster based on available CPU cores.",
      implementation: [
...
sonar.ce.workerCount=4`,
    ...
    },
    {
      ...
      description:
        "Exclude unnecessary files and directories from analysis to significantly reduce scan time and resource usage.",
      implementation: [
...
sonar.exclusions=\\
  ...
  **/*.generated.ts`,
    ...
    },
    {
      ...
      description:
        "Use incremental analysis to scan only changed files in pull requests, dramatically reducing analysis time.",
      implementation: [
...
# Scanner will automatically analyze only changed files`,
    ...
    },
    {
      ...
      description:
        "Disable unnecessary rules and focus on critical issues to reduce analysis time and computational overhead.",
      implementation: [
...
# - Duplicates of other rules`,
    ...
    },
    {
      ...
      description:
        "Optimize Elasticsearch settings for faster search and better UI responsiveness.",
      implementation: [
...
bootstrap.memory_lock=true`,
    ...
    },
    {
      ...
      description:
        "Configure scanner to process files in parallel using multiple CPU cores.",
      implementation: [
...
sonar-scanner -Dsonar.scanner.parallelThreads=4`,
    ...
    },
    {
      ...
      description:
        "Properly manage scanner cache to speed up repeated analyses.",
      implementation: [
...
- name: Cache SonarQube packages
  ...
  with:
    ...
    },
    {
      ...
      description:
        "Configure webhooks efficiently to reduce unnecessary network calls and processing.",
      implementation: [
...
# - Monitor failed deliveries`,
  ...
  const filteredTips = tips.filter((tip) => {
    ...
    const matchesImpact =
      selectedImpact === "all" || tip.impact === selectedImpact;
      ...
      <div className="bg-gradient-to-r from-yellow-600 to-orange-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <p className="text-xl text-yellow-100 max-w-3xl">
            Expert tips to maximize SonarQube performance and reduce analysis
            time
          </p>
        </div>
      </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg p-6 mb-8 border border-slate-200">
          ...
          <div className="mt-4 flex items-center gap-2 text-sm text-slate-600">
            ...
            <span>
              ...
              optimization{filteredTips.length !== 1 ? "s" : ""}
            </span>
          </div>
        </div>
              ...
              >
                <div className="p-6">
                  <div className="flex items-start gap-4 mb-4">
                    <div
                      className={`flex-shrink-0 w-12 h-12 bg-gradient-to-br ${tip.iconBg} rounded-xl flex items-center justify-center shadow-md`}
                    >
                    ...
                    <div className="bg-white/50 backdrop-blur-sm rounded-lg p-4 border border-slate-200">
                      ...
                      <ol className="space-y-2">
                        {tip.implementation.map((step, idx) => (
                          ...
                          >
                            <span className="font-semibold text-slate-500 min-w-[1.5rem]">
                              {idx + 1}.
                            </span>
                            <span>{step}</span>
                          </li>
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <div className="bg-white/10 rounded-lg p-4">
              ...
              <p className="text-sm text-purple-100">
                Track scan duration before and after
              </p>
            </div>
            <div className="bg-white/10 rounded-lg p-4">
              <h3 className="font-semibold mb-2">💾 Memory Usage</h3>
              <p className="text-sm text-purple-100">
                Monitor heap and system memory
              </p>
            </div>
            <div className="bg-white/10 rounded-lg p-4">
              <h3 className="font-semibold mb-2">🔄 Queue Times</h3>
              <p className="text-sm text-purple-100">
                Check Compute Engine processing
              </p>
            </div>
            <div className="bg-white/10 rounded-lg p-4">
